    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Add Income</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a>
                </li>
                <li class="breadcrumb-item"><a href="all-income.php">Incomes</a>
                </li>
                <li class="breadcrumb-item ">Add Income
                </li>
              </ol>
            </div>
          </div>
...
<?php
	if(isset($_POST['add_income'])){
		$inccat = htmlspecialchars($_POST["incomecat"]);
		...
		if($res){
			...
			Income Added Successfully!
				...
				Some Problem Occurs, Please Try Again. 
					...
					echo "<div class='alert alert-danger alert-dismissable'>
					<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Please select a Category!!!!
					</div>";
				}	
                    ...
                    <form method="Post" class="form" validate>
                      <div class="form-body">
                      	<div class="form-group">
                              ...
                              <select id="incomecat" name="incomecat" class="form-control round">
                      ...
                      <div class="form-actions">
                        <button name="add_income" type="submit" class="btn btn-primary block">
