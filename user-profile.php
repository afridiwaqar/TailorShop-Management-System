...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>User Profile - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="#"><i class="la la-user"></i><span class="menu-title" data-i18n="Users">Users</span></a>
            <ul class="menu-content">
              ...
              <li class="active"><a class="menu-item" href="user-profile.html"><i></i><span data-i18n="Users Profile">Users Profile</span></a>
              </li>
