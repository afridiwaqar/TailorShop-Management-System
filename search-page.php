...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Search Page - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
        ...
        <div class="col-lg-6 col-10">
            ...
            <div class="row py-2">
                <div class="col-12 text-center">
                    <a href="search-website.html" class="btn btn-primary btn-md mb-1"><i class="ft-search"></i> Modern Search</a>
                    <span class="dropdown">
