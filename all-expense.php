...
delete_item_from('expense',$expid);
}
		...
		<div class="content-wrapper">
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-12 mb-2">
					<h3 class="content-header-title">All Expenses</h3>
					<div class="row breadcrumbs-top">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">All Expenses
								</li>
							</ol>
						</div>
					</div>
...
$rname =	$rname->fetch(PDO::FETCH_ASSOC);	
 echo "<tr>                                         <td>$data[id]</td>
          ...
          <td>$data[date]</td>
					<td>$$data[amount]</td>
          <td>
          <a href='all-expense.php?id=$data[id]' class='btn btn-info btn-xs'>Edit</a><a href='all-expense.php?expid=$data[id]'><button type='button' class='btn btn-danger btn-xs'>DELETE</button></a>
          </td>
         </tr>
          ";
}
