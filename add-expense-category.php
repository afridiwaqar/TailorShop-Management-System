			...
			<div class="content-header-light col-12">
				<div class="row">
					<div class="content-header-left col-md-9 col-12 mb-2">
						<h3 class="content-header-title"> Add New Expense Category</h3>
						<div class="row breadcrumbs-top">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.php">Dashboard</a>
									</li>
									<li class="breadcrumb-item"><a href="all-expense-category.php">Expense Categories</a>
									</li>
									<li class="breadcrumb-item"><a href="add-expense-category.php">Add Expense Category</a>
									</li>									
								</ol>
							</div>
						</div>
...
if (!isset($error) || $error == 0){
	...
	NEW EXPENSE CATEGORY Added Successfully!
			...
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Some Problem Occurs, Please Try Again. 
			</div>";
	}
						...
						<div class="col-md-11">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-icons"> Add New Expense Category</h4>
